...
export const normalWeight = (height: number, gender: string) => {

    const idealWeight =
        gender === "man" ? Math.round(56.2 * 1 + (height * 0.39 - 152.4 * 0.39) * 1.41) * 1 : Math.round(53.1 * 1 + (height * 0.39 - 152.4 * 0.39) * 1.36) * 1;
    return idealWeight;
};
